...
import Logo from "@/shared/config/logo";
    ...
    <>
      ...
      <aside
        className={css({
          ...
          transition:
            "width 0.3s cubic-bezier(0.2, 0.8, 0.2, 1), transform 0.3s cubic-bezier(0.2, 0.8, 0.2, 1)",
          zIndex: 100,
          "@media (max-width: 768px)": {
            width: "260px",
      ...
      >
        ...
        <div>
          ...
          >
            {/* Logo Icono Simulado */}
            <Logo size={32} color={theme.colors.contentInversePrimary} />
